...
<%@ include file="layout-head.jsp" %>
	  <div class="shadow-sm m-4 p-2 text-monospace col-md-5 bg-dark text-light"><strong>Create new User</strong></div>
	    <form class="col-md-5 m-4 shadow p-4 border border-danger " method="POST" action="add_user">
